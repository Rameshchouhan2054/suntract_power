...
<div class="modal fade modal-md" id="slider_image_preview" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <img id="slider_image" src="" alt="Icon">
            </div>
        </div>
    </div>
                    ...
                    <table class="table" id="category_list">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>  <img onclick="slider_image_preview('<?php echo $row->slider_image_address ?>')" class="shadow" src="<?php echo base_url('assets/img/slider-image/'.$row->slider_image_address) ?>"  alt="Icon" style="width:50%;max-width:100px"/> </td>                                                           
...
function slider_image_preview(image_name)
{
    console.log(image_name);
    $("#slider_image").attr('src', base_url+'assets/img/slider-image/'+image_name);
    $("#slider_image_preview").modal("show");
}
</script>
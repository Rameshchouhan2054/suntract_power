...
<div class="content-wrapper" style="margin-top:60px">
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    <a href="<?php echo  base_url(empty($new_entry_link) ? "" : $new_entry_link) ?>" class="btn btn-secondary float-sm-right " id="responsive-content"><?php echo  empty($new_entry_caption) ? "" : $new_entry_caption; ?></a>
                </div>
            </div>
            <div class="row">
                <div class="col mt-1">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="display: flex; font-size:20px">
                                        <a class="ml-3" style="color:red" onclick="return confirm('Are you sure you want delete Backend user <?php echo $row->username ?>')" href="delete-user/<?php echo  $row->id ?>" data-toggle="tooltip" data-placement="top" title="Delete"> <i class="fa fa-trash" aria-hidden="true"></i></a>
                                        ...
                                        <a class="ml-3 text-success" href="edit-backend-user/<?php echo  $row->id ?>" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa  fa-edit" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }

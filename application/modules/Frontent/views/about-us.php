    ...
    <div class="auto-container">
        <div class="breadcrumb-box">
            <div class="auto-container">
                ...
                <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Strnix World&#039;s Energy." href="" class="home"><span property="name">Strnix World&#039;s Energy</span></a>
                    <meta property="position" content="1">
                </span> &#8594; <span class="post post-page current-item">About Suntract Power</span>
            </div>
        </div>
                                                        ...
                                                        <div class="title-column col-lg-5 col-md-12 col-sm-12 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="2000ms">
                                                            <div class="inner">
                                                                <div class="sec-title dark-title wow fadeInLeft left" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                                    ...
                                                                    <h2>Helping Smart Comapnies With Better Integrated Solar Solutions</h2>
                                                    ...
                                                    <div class="lower-content">
                                                        <div class="row clearfix">
                                                            <div class="default-block col-lg-4 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="2000ms">
                                                                <div class="inner-box">
                                                                    <div class="image-box">
                                                                        <a href="#"><img src="<?php echo base_url() ?>assets/uploads/2020/06/featured-image-32.jpg" alt=""></a>
                                                                    </div>
                                                                    <div class="lower-box">
                                                                        <div class="count">00</div>
                                                                        <h3><a href="JavaScript:void(0);">Residential Solutions</a></h3>
                                                                        <div class="text">Pellentesque porta velit faucibs kodales dolor rhoncus sed curabitur
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="default-block col-lg-4 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="2000ms">
                                                                <div class="inner-box">
                                                                    <div class="image-box">
                                                                        <a href="#"><img src="<?php echo base_url() ?>assets/uploads/2020/06/featured-image-33.jpg" alt=""></a>
                                                                    </div>
                                                                    <div class="lower-box">
                                                            ...
                                                            <div class="default-block col-lg-4 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="2000ms">
                                                                <div class="inner-box">
                                                                    <div class="image-box">
                                                                        <a href="#"><img src="<?php echo base_url() ?>assets/uploads/2020/06/featured-image-34.jpg" alt=""></a>
                                                                    </div>
                                                                    <div class="lower-box">
                                                ...
                                                <div class="auto-container">
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                                                            <div class="inner-box">
                                                                <div class="image-box">
                                                                    <div class="image"><a href="javascript:void(0)"><img src="<?php echo base_url() ?>assets/uploads/2020/06/team-image-1.jpg" alt=""></a></div>
                                                                    <div class="social-links">
                                                                        <ul>
                                                                            <li><a href="void(0.html"><span class="fab fa-twitter"></span></a></li>
                                                                            <li><a href="void(0.html"><span class="fab fa-instagram"></span></a></li>
                                                                            <li><a href="void(0.html"><span class="fab fa-linkedin-in"></span></a></li>
                                                                            <li><a href="void(0.html"><span class="fab fa-facebook-f"></span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                <div class="lower-box">
                                                        ...
                                                        <div class="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                                                            <div class="inner-box">
                                                                <div class="image-box">
                                                                    <div class="image"><a href="javascript:void(0)"><img src="<?php echo base_url() ?>assets/uploads/2020/06/team-image-2.jpg" alt=""></a></div>
                                                                    <div class="social-links">
                                                                        <ul>
                                                                            <li><a href="void(0.html"><span class="fab fa-twitter"></span></a></li>
                                                                            <li><a href="void(0.html"><span class="fab fa-instagram"></span></a></li>
                                                        ...
                                                        <div class="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                                                            <div class="inner-box">
                                                                <div class="image-box">
                                                                    <div class="image"><a href="javascript:void(0)"><img src="<?php echo base_url() ?>assets/uploads/2020/06/team-image-3.jpg" alt=""></a></div>
                                                                    <div class="social-links">
                                                                        <ul>
                                                                            <li><a href="void(0.html"><span class="fab fa-twitter"></span></a></li>
                                                                            <li><a href="void(0.html"><span class="fab fa-instagram"></span></a></li>
                                                        ...
                                                        <div class="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                                                            <div class="inner-box">
                                                                <div class="image-box">
                                                                    <div class="image"><a href="javascript:void(0)"><img src="<?php echo base_url() ?>assets/uploads/2020/06/team-image-4.jpg" alt=""></a></div>
                                                                    <div class="social-links">
                                                                        <ul>
                                                                            <li><a href="void(0.html"><span class="fab fa-twitter"></span></a></li>
                                                                            <li><a href="void(0.html"><span class="fab fa-instagram"></span></a></li>

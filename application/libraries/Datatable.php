...
class Datatable
{
    ...
    private $_CI;
    private $_systemOperations = array('VIEW', 'VIEW_ICON', 'EDIT', 'EDIT_ICON', 'RESTORE_ICON', 'DELETE', 'DELETE_ICON', 'PRINT', 'PRINT_ICON', 'OTHER_ICON', 'OTHER_TEXT', 'STATUS_ICON', 'SORT_ICON', 'REQUEST_VIEW_ICON', 'UPDATE', 'UPDATE_ICON', 'HISTORY', 'HISTORY_ICON', 'COPY_ICON');
    ...
    public function make_table($configIndex, $table_config)
    {
        ...
        if (empty($table_config['datatable_class'])) {
            ...
            $css_class = 'class="dyntable table dt-responsive  dataTable table-hover"';
            ...
            switch ($configArr['callBackType']) {
                ...
                case 'helper':
                    ...
                    if (!empty($configArr['callBackParam'])) {
                        if (!empty($configArr['callBackFunction'])) {

                            if (is_array($configArr['callBackFunction'])) {

                                foreach ($configArr['callBackFunction'] as $function) {
                                    $callBackParam = $configArr['callBackParam'];
                                    $return = $return . $function($fieldValue, $callBackParam, $objectRow);
                                }
                            } else {
